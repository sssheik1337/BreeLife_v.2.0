...
- Weekly-анализ отклонений (включая AI-стаб) сравнивает факт только с `profile.calories_target`; `tdee_calories` используется как справочный ориентир и не участвует в статусах overeat/undereat.
